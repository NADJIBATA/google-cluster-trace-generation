...
CONFIG = {
    'scenarios_dir': 'data/generated/gen2',
    'output_dir': 'data/generated/gen2/scenarios_csv',
...
scenarios = {}
for file in sorted(scenarios_dir.glob("*.npy")):
    name = file.stem
    data = np.load(file)
    scenarios[name] = data
...
CONFIG = {
    ...
    'output_dir': 'results/scenarios_csv',
    'scaler_path': 'data/processed/sequences/scaler.pkl',
